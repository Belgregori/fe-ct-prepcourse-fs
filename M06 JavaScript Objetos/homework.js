...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   newObject = {nombre:nombre,email:email,password:password};
   return newObject;
}
...
function agregarPropiedad(objeto, propiedad) {
   ...
   // Retornar el objeto.
   // Tu código:
    objeto[propiedad] =null;   //agregar una propiedad
    return objeto; 
}
...
function invocarMetodo(objeto, metodo) {
   ...
   // Tu código:
  objeto[metodo]();  //invocar un metodo
}
...
function actualizarPassword(objetoUsuario, nuevaPassword) {
   ...
   return objetoUsuario;  //cambiar una propiedad
}

function agregarAmigo(objetoUsuario, nuevoAmigo) {
   // El parámetro (objeto)"objetoUsuario" tiene una propiedad llamada "amigos" igual a un arreglo.
